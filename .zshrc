...
extensions[archives]="7z ace apk arj bin bundle bz2 cab cdr dat deb dmg firmware ear exe gz img ipk iso jar lzh lzma ova pgdump qcow qcow2 rar rootfs rpm squashfs tar taz tgz udeb udf vmdk war xpi xz z zip"
...
case $HOST_SHORT in
  centurion|hulk|x230|seb-debian|x1) # no fallback to unset'ing DISPLAY
    ;;
  vb)
    export TERM=cygwin ;;
  *)
