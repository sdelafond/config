...
extensions[archives]="7z ace apk arj bin bundle bz2 cab cdr dat deb dmg firmware ear exe gz img iso jar lzh lzma ova pgdump qcow qcow2 rar rootfs rpm squashfs tar taz tgz udeb udf vmdk war xpi xz z zip"
...
extensions[code]="${literal}Makefile a bash c c++ class cpp debdiff diff el elz h hs jacl java js jy ko lua o out patch pl pm py pyc pyo rb sh so sql tcl zsh"
