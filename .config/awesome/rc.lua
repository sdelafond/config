...
settings.applications = { ["terminal"]        = 'xsc',
			  ...
			  ["backlight"]       = os.getenv("HOME") .. '/bin/xbacklight.sh',
...
settings.tags_defs = { { shortcut = "1", layout = settings.default_layout },
		       ...
		       {  shortcut = "9", layout = awful.layout.suit.max, name = "VMs" },
...
settings.bindings.command = {
  ...
  [{settings.keys.none, "XF86MonBrightnessDown"}] = settings.applications.backlight .. " -dec 2",
