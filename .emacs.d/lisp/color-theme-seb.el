...
;;      (background-color . "transparent")
     ...
     (ledger-occur-xact-face ((t (:foreground "orange"))))
     ...
     (gnus-cite-1 ((t (:foreground "color-34"))))
     (gnus-cite-2 ((t (:foreground "color-36"))))
     (gnus-cite-3 ((t (:foreground "color-50"))))
     (gnus-cite-4 ((t (:foreground "color-58"))))
     (gnus-cite-5 ((t (:foreground "color-72"))))
     (gnus-cite-6 ((t (:foreground "color-86"))))
     (gnus-cite-7 ((t (:foreground "color-16"))))
     (gnus-cite-8 ((t (:foreground "color-17"))))
